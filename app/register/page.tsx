...
export default function RegisterPage() {
  ...
  const eyeToggle = (show: boolean, onToggle: () => void, label: string) => (
    <button
      type="button"
      onClick={onToggle}
      disabled={loading}
      className="cursor-pointer text-slate-500 hover:text-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/50 rounded-r-lg transition disabled:opacity-50 w-full h-full flex items-center justify-center"
      aria-label={label}
    >
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            <InputField
              label="Company Name"
              name="companyName"
              placeholder="e.g. Batangas Star Bus Lines"
          ...
          <Button
            type="submit"
            disabled={loading}
            className="cursor-pointer w-full h-11 mt-1 bg-blue-600 hover:bg-blue-700 active:scale-[0.99] text-white text-sm font-semibold rounded-lg disabled:opacity-50"
          >
            {loading ? (
              <>
